...
- **weight**: full BIA body composition (weight, body_fat_mass, skeletal_muscle_mass, muscle_mass, fat_free_mass, bmr). Reproduces known profile values (<YOUR_WEIGHT_KG> / 33.<YOUR_WEIGHT_KG> skeletal) — the strongest parse validation available.
