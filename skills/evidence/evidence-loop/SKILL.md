...
5. **Controls before headlines.** For any pre/post or era contrast ask: "what else changed at the same time?" Season-matching killed a +<YOUR_RESTING_HR_BPM> "assist effect" to −0.8 (NULL). Naive baselines are the #1 artifact source.
