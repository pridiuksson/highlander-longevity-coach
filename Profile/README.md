...
| [`Concise/`](./Concise/) | **Fast-paced & Action-oriented.** Concise, 2–3 questions at once, strictly small actionable messages, no walls of text. | Busy professionals, mobile messaging users (WhatsApp/Signal/Telegram), or anyone overwhelmed by long essays. |
