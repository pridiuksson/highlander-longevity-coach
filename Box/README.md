...
cookbook your agent executes — point the agent at the cookbook's markdown file (e.g.
[Nebius/nebius-cpu-box-cookbook.md](./Nebius/nebius-cpu-box-cookbook.md)) and it does the work,
